...
public class StudentServiceImpl implements StudentService {
	...
	@Override
	public Integer addStudent(Student s) throws DatabaseException {
	...
	@Override
	public Student getStudent(Integer rno) throws DatabaseException {
	...
	@Override
	public List<Student> getStudentsByName(String name) throws DatabaseException {
		return StudentDaoFactory.getStudentDaoInstance().fetchStudentsByName(name.toLowerCase().trim());
	}

	@Override
	public List<Student> getStudentsByCity(String city) throws DatabaseException {
